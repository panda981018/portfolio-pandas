...
import com.pandas.portfolio.domain.repository.ProjectRepository
import com.pandas.portfolio.domain.repository.SkillRepository
...
class AdminProjectSkillService(
    ...
    fun getProjectSkillTable(): TableDTO {
        ...
        val columns = mutableListOf<String>(
                ...
                "createdDateTime", "updateDateTime"
        )
