package com.pandas.portfolio.admin.context.experience.controller

import com.pandas.portfolio.admin.context.experience.service.AdminExperienceService
import com.pandas.portfolio.admin.data.FormElementDTO
import com.pandas.portfolio.admin.data.SelectFormElementDTO
import com.pandas.portfolio.admin.data.TextFormElementDTO
...
class AdminExperienceViewController(
    ...
    fun experience(model: Model): String {
        val formElements = listOf<FormElementDTO>(
                ...
                SelectFormElementDTO("startYear", 3, (2015..2030).toList()),
                SelectFormElementDTO("startMonth", 2, (1..12).toList()),
                SelectFormElementDTO("endYear", 3, (2015..2030).toList()),
