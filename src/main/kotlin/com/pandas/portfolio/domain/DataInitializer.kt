package com.pandas.portfolio.domain

import com.pandas.portfolio.domain.constant.SkillType
import com.pandas.portfolio.domain.entity.*
import com.pandas.portfolio.domain.repository.*
    ...
    fun initializeData() {
        ...
        val achievements = mutableListOf<Achievement>(
                Achievement(
                        ...
                        host = "캣카오",
                        achievedDate = LocalDate.of(2025, 3, 3),
                        isActive = true
                ),
                Achievement(
                        title = "정보처리기사",
                        ...
                        host = "한국산업인력공단",
                        achievedDate = LocalDate.of(2025, 6, 12),
                        isActive = true
                ),
        )
        ...
        val links = mutableListOf<Link>(
                Link(name = "Github", content = "https://github.com/panda981018", isActive = true),
                Link(
                        name = "Linkedin",
                        content = "https://www.linkedin.com/in/%EC%A7%80%EC%9B%90-%EC%A0%95-561999228?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app",
                        isActive = true
                )
        )
        ...
        project1.addDetails(
                mutableListOf(
                        ...
                        ProjectDetail(content = "Redis를 적용하여 인기 게시글의 조회 속도를 1.5초 -> 0.5초로 개선", url = null, isActive = true),
                )
        )
