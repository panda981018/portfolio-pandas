package com.pandas.portfolio.presentation.service

import com.pandas.portfolio.domain.entity.Introduction
import com.pandas.portfolio.domain.entity.Link
import com.pandas.portfolio.presentation.repository.PresentationRepository
...
class PresentationServiceTest {
    ...
    fun testGetIntroductions() {
        ...
        for (i in 1..DATA_SIZE) {
            val introduction = Introduction(content = "${i}", isActive = i % 2 == 0) // 짝수만 true
